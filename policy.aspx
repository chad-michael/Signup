        ...
        <form id="form1" runat="server">
            <div>
                <div class="table-responsive">
                    <table class="PageBoundingBox no-border indent">
                        <tr>
                            <td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="MainContent">
                                            ...
                                            <table>
                                                <tr>
                                                    <td>
                                                        <h1 class="title" style="clear: right; width: 100%; margin: auto; padding-bottom: 20px;">Delta College Electronic Resource Access and Use Guidelines</h1>

                                                        <div class="Eraug" id="Eraug" style="margin-top: 25px;">
                                                            ...
                                                            <ol>
                                                                ...
                                                                <li>The following list is provided as an illustration, but not an exhaustive list, of the kinds of uses that could subject you to penalties by the College or by outside authority:
                                                                        <ol style="list-style-type: circle; margin-left: 4.5em; padding-top: 2em; padding-bottom: -1em;">
                                                                ...
                                                                <li>Consequences and process will depend on the violation. When required to protect others or system integrity, immediate termination, removal of pages or other materials, suspension of user privileges, or other actions may occur. Otherwise, the user will normally be
                                                                        ...
                                                                        and could be heard under the Judicial Process, Senate Policy 2.065; Student Violation of College Rules and Regulations, Senate Policy 8.045; Disciplinary Action, Support                                                                     Staff Policies and Procedures 1.12; the Grievance/ComplaintProcedures for Equal Opportunity/ Equity Concerns, or other appropriate collegepolicies, procedures, or guidelines, or could be referred to outside
                                                        ...
                                                        <div style="margin-bottom: 2em;">
                                                            <span style="font-size: 9.5pt; clear: right; font-family: myriad-pro;"><strong>Last Revision 9/7/2006</strong></span>
                                                        </div>

                                                        <div style="margin-top: -1.5em;">
                                                            <p style="clear: both; margin: 1.75em 0 .25em 0; font-family: myriad-pro-bold !important;"><a href="disagree.aspx">I DISAGREE and will NOT follow your Code of Responsible Computer Usage</a></p>
                                                            <p style="clear: both; margin: 0 0 1em 0; font-family: myriad-pro-bold !important;"><a href="default.aspx">I AGREE and will follow your Code of Responsible Computer Usage</a></p>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
