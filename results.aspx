...
This error has been logged. 
                 ...
                 <asp:Panel ID="DeltaNet" runat="server" Width="100%">
                     ...
                     <br />
                     Faculty and Staff have access to <a href="https://portal.delta.edu"><span style="color: #0000ff;
                         text-decoration: underline">https://portal.delta.edu</span></a>. To enter
                 ...
                 <asp:Panel ID="EmailFacStaff" runat="server" Width="100%" Visible="false">
                     ...
                     Center at <a href="https://Portal.delta.edu/cos/Pages/default.aspx"><span style="color: #0000ff;
                         text-decoration: underline">https://Portal.delta.edu/cos/Pages/default.aspx</span></a>.</asp:Panel>
                 ...
                 <asp:Panel ID="Educator" runat="server" Width="100%">
                     ...
                     Delta College username and password to log into your electronic course site at <a
                         href="http://eLearning.Delta.edu"><span style="color: #0000ff; text-decoration: underline">
                             http://elearning.delta.edu </span></a>
                 </asp:Panel>
                 <br />
